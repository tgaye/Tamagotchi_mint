...
import { WhitelistProvider } from './WhitelistContext'; // Adjust the import path as necessary
 ...
 function Account() {
  ...
  async function checkWhitelist(address: string) {
    try {
        ...
        const userWhitelistDetails = data.whiteList.find((whitelistEntry) => whitelistEntry.address.toLowerCase() === address.toLowerCase());
